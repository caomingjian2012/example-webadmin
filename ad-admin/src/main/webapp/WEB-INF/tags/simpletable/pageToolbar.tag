...
<%@ attribute name="linkPageNumbers" type="java.util.List" required="false"  %>

<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>

<%
	// set default values
	Integer[] defaultPageSizes = new Integer[]{10,20,30,50,100};
	...
	if(jspContext.getAttribute("linkPageNumbers") == null) {
		jspContext.setAttribute("linkPageNumbers",page.getLinkPageNumbers()); 
	} 
%>
	...
	<td>
		<div class="box">
			...
			<div class="paginationControls">
				<span class="buttonLabel">第 ${page.thisPageFirstElementNumber} - ${page.thisPageLastElementNumber} 条 共 ${page.totalCount} 条记录</span>
				...
				<c:otherwise><img src="<c:url value='/widgets/simpletable/images/prevPageDisabled.gif'/>" style="border:0" ></c:otherwise>
				 ...
				 %>
				<c:forEach var="item" items="${linkPageNumbers}">
