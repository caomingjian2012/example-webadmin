...
<title>CPS收益列表</title>
	...
	<div class="row-fluid">
				<div class="span12">
					<a href="cpsProfit/add"  class="btn btn-primary">添加</a>
	 ...
	 <form class="form-inline" id="queryForm" name="queryForm" action="" method="get">			
			<div class="row-fluid">
				<div class="span12">
					 APK推广渠道：	<input type="text" name="kw" value="${query.kw }">
							...
							<c:if test="${!empty page.result }">
								<c:forEach items="${page.result }" var="item" varStatus="vs">
									...
									<tr>
										...
										<td class="op">
										&nbsp;	<a  href="cpsProfit/edit?id=${item.id}">修改</a>
