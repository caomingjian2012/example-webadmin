...
function del(id){
	...
	<body>
			<div class="row-fluid">
				<div class="span12">
					<a href="apkBlackList/add"  class="btn btn-primary ajax">添加</a>
			...
			<div class="row-fluid">
				...
				&nbsp;推广渠道：<input type="text" name="kw" id="kw" value="${query.kw }"  class="input-medium" style="width: 100px">
