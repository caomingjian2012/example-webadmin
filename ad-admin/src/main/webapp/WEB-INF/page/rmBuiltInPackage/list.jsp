...
function del(id){
	...
	<body>
			<div class="row-fluid">
				<div class="span12">
					<a href="rmBuiltInPackage/add"  class="btn btn-primary ajax">添加</a>
			...
			<div class="row-fluid">
				...
				&nbsp;UUID：<input type="text" name="packageName" id="packageName" value="${query.packageName }"  class="input-medium" style="width: 100px">
