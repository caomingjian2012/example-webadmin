...
<body>
	...
	<form action="" method="post" name="addForm">
			...
			<td><input type="file" id="file" name="file"/>
				...
				<input type="text" name="img" id="img" value="${entity.img }" style="width: 400px !important" readonly="readonly"/>
		...
		<tr> 
			...
			<td>
			<div id="iconDiv" ><img id="iconshow" name="iconshow" src="${entity.img }"/></div>
			 </td>
			</tr>
			...
			<td>
					<textarea id="channelArr"  name="channelArr" rows="5" cols="30">
